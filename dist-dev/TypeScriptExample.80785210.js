...
},{"process":9}],10:[function(require,module,exports) {
"use strict";
...
var MyModel = function (_super) {
    ...
    function MyModel() {
        ...
        _this.name = 'Conbo via ParcelJS';
        return _this;
    }
    return MyModel;
}(conbo_1.Hash);
exports.default = MyModel;
},{"conbo":7}],20:[function(require,module,exports) {
"use strict";
...
var View1 = function (_super) {
    ...
    View1.prototype.declarations = function () {
        this.tagName = 'p';
        this.template = "View 1";
    };
    __decorate([conbo_1.Inject], View1.prototype, "myModel", void 0);
    View1 = __decorate([conbo_1.Viewable('conbo.example.typescript', 'View1')], View1);
    return View1;
}(conbo_1.View);
exports.default = View1;
},{"conbo":7}],21:[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var conbo_1 = require("conbo");
var View2 = function (_super) {
    __extends(View2, _super);
    function View2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    View2.prototype.declarations = function () {
        this.tagName = 'p';
        this.template = "View 2";
    };
    __decorate([conbo_1.Inject], View2.prototype, "myModel", void 0);
    View2 = __decorate([conbo_1.Viewable('conbo.example.typescript', 'View2')], View2);
    return View2;
}(conbo_1.View);
exports.default = View2;
},{"conbo":7}],16:[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var conbo_1 = require("conbo");
var View1_1 = require("../view/View1");
var View2_1 = require("../view/View2");
var MyRouter = function (_super) {
    __extends(MyRouter, _super);
    function MyRouter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MyRouter.prototype.declarations = function (options) {
        this.context = options.context;
        this.container = this.context.app;
        this.context.namespace['View1'] = View1_1.default;
        this.context.namespace['View2'] = View2_1.default;
        this.routes = {
            '/': '',
            'View1': 'View1',
            'View2': 'View2'
    ...
    MyRouter.prototype.initialize = function () {
        this.addEventListener(conbo_1.ConboEvent.FAULT, this.faultHandler, this).addEventListener(conbo_1.ConboEvent.ROUTE, this.routeHandler, this).start();
    };
    MyRouter.prototype.routeHandler = function (event) {
        if (!!this.currentView) {
    ...
    MyRouter.prototype.faultHandler = function (arg0, arg1, arg2) {
        console.warn('faultHandler Method not implemented.');
    };
    return MyRouter;
}(conbo_1.Router);
exports.default = MyRouter;
},{"conbo":7,"../view/View1":20,"../view/View2":21}],4:[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var conbo_1 = require("conbo");
var MyModel_1 = require("../model/MyModel");
...
var MyContext = function (_super) {
    ...
    MyContext.prototype.initialize = function () {
        this.mapSingleton('myModel', MyModel_1.default);
        this.mapSingleton('myRouter', MyRouter_1.default, { context: this });
    };
    return MyContext;
}(conbo_1.Context);
exports.default = MyContext;
},{"conbo":7,"../model/MyModel":10,"./MyRouter":16}],5:[function(require,module,exports) {
"use strict";
...
var InputView = function (_super) {
    ...
    InputView.prototype.declarations = function () {
        this.tagName = 'p';
        this.template = "My name is <input type=\"text\" placeholder=\"Name\" cb-bind=\"myModel.name\" />\n\t\t<a href=\"./#!View1\">view 1</a>\n\t\t<a href=\"./#!View2\">view 2</a>\n\t\t";
    };
    __decorate([conbo_1.Inject], InputView.prototype, "myModel", void 0);
    InputView = __decorate([conbo_1.Viewable('conbo.example.typescript', 'InputView')], InputView);
    return InputView;
}(conbo_1.View);
exports.default = InputView;
},{"conbo":7}],6:[function(require,module,exports) {
"use strict";
...
var OutputView = function (_super) {
    ...
    OutputView.prototype.declarations = function () {
        this.tagName = 'h1';
        this.template = "Hello, {{myModel.name|parseName}}!";
    };
    OutputView.prototype.parseName = function (name) {
        return name || 'Stranger';
    };
    __decorate([conbo_1.Inject], OutputView.prototype, "myModel", void 0);
    OutputView = __decorate([conbo_1.Viewable('conbo.example.typescript', 'OutputView')], OutputView);
    return OutputView;
}(conbo_1.View);
exports.default = OutputView;
},{"conbo":7}],2:[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
require("./TypeScriptExample.scss");
var conbo = require("conbo");
var conbo_1 = require("conbo");
var MyContext_1 = require("./core/MyContext");
var InputView_1 = require("./view/InputView");
var OutputView_1 = require("./view/OutputView");
var TypeScriptExample = function (_super) {
    __extends(TypeScriptExample, _super);
    function TypeScriptExample() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TypeScriptExample.prototype.declarations = function () {
        this.namespace = conbo('conbo.example.typescript');
        this.contextClass = MyContext_1.default;
    };
    TypeScriptExample.prototype.initialize = function () {
        console.info('Hello from ConboJS using TypeScript, SASS & Webpack!');
        this.myRouter.setPath('/');
        this.appendView(new OutputView_1.default(this.context), new InputView_1.default(this.context));
    };
    __decorate([conbo_1.Inject], TypeScriptExample.prototype, "myRouter", void 0);
    TypeScriptExample = __decorate([conbo_1.Viewable('conbo.example.typescript', 'TypeScriptExample')], TypeScriptExample);
    return TypeScriptExample;
}(conbo_1.Application);
exports.default = TypeScriptExample;
},{"./TypeScriptExample.scss":3,"conbo":7,"./core/MyContext":4,"./view/InputView":5,"./view/OutputView":6}],22:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/TypeScriptExample.80785210.map